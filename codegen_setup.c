...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Team Buddies",
    .project_root_env = "TEAM_BUDDIES_PROJECT_ROOT",
    .build_dir_env = "TEAM_BUDDIES_BUILD_DIR",
    .force_setup_env = "TEAM_BUDDIES_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_029.86_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Team_Buddies",
    .prepare_note =
